import { SessionDashboard } from "./applications/session-dashboard.js?v=1.12.2";
import { PlayerDiary } from "./applications/player-diary.js?v=1.12.2";
...
import { PlayerDiaryService } from "./services/player-diary-service.js?v=1.12.2";
