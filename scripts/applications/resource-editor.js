...
import { PLACE_LAYOUTS, PLACE_TYPES, ResourceService, RESOURCE_FIELDS } from "../services/resource-service.js?v=1.4.7";
...
import { CityMapController } from "./city-map-controller.js?v=1.4.7";
